...
function Page(_ref5) {
  ...
  var zIndex = interpolatedStyles.zIndex,
    otherStyles = _objectWithoutPropertiesLoose(interpolatedStyles, _excluded); // zIndex is not a requirement of interpolation
...
var PagerContext = /*#__PURE__*/ React.createContext(undefined);
...
var FocusContext = /*#__PURE__*/ React__default.createContext(false);
...
var IndexContext = /*#__PURE__*/ React__default.createContext(undefined);
  ...
  return Object.keys(pageInterpolation).reduce(function(styles, key) {
    ...
    if (typeof currentStyle === 'object') {
      ...
      var unit = currentStyle.unit,
        rest = _objectWithoutPropertiesLoose(currentStyle, _excluded2);

      if (currentStyle.unit) {
        _style3 = concat(interpolateNode(offset, rest), currentStyle.unit);
      } else {
        _style3 = interpolateNode(offset, currentStyle);
      }
...
var interpolateNode$1 = Animated.interpolateNode,
...
function interpolateWithConfig$1(offset, pageInterpolation) {
  ...
  return Object.keys(pageInterpolation).reduce(function(styles, key) {
    ...
    if (typeof currentStyle === 'object') {
      ...
      var unit = currentStyle.unit,
        rest = _objectWithoutPropertiesLoose(currentStyle, _excluded$1);

      if (currentStyle.unit) {
        _style2 = concat$1(interpolateNode$1(offset, rest), currentStyle.unit);
      } else {
        _style2 = interpolateNode$1(offset, currentStyle);
      }
